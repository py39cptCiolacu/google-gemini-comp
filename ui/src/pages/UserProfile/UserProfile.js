...
import { MDBCol, MDBContainer, MDBRow, MDBCard, MDBCardText, MDBCardBody, MDBCardImage, MDBBtn, MDBTypography, MDBTable, MDBTableHead, MDBTableBody} from 'mdb-react-ui-kit';
                    ...
                    <div className="mb-5">
                      <p className="lead fw-normal mb-1">Functionalities</p>
                        <div className="d-flex flex-column align-items-center" style={{ backgroundColor: '#f8f9fa' }}>
                          ...
                          <MDBBtn className="d-block" style={{ backgroundColor: 'green' }}>Get suggestion</MDBBtn>
                      </div>
                    </div>
